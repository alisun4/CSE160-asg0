...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        if (other1.elements.length !== other2.elements.length) {
          throw new Error('Vectors must have the same length for dot products');
        }
    ...
    static cross(other1, other2) {
        ...
        if (other1.elements.length !== 3 || other2.elements.length !== 3) {
    ...
    /**
      * Source: https://gist.github.com/jjgrainger/808640fcb5764cf92c3cad960682c677
